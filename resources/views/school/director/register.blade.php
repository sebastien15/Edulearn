        ...
        <div class="row w-100">
          <div class="col-lg-10 col-md-12 col-sm-12 col-12 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">To Register Your School is even Simpler. It only takes a few steps</h6>
              <form class="pt-3">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                           <input type="" name="" class="form-control" placeholder="telephone number.." />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="{{route('director.login')}}" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
