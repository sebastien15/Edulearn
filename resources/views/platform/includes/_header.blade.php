        ...
        <div class="container-full">
        	<div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12">
                    ...
                    <div id="logo">
                        <a href="01-home.html"><img src="{{asset('platformPublic/img/logo.png')}}" alt=""></a>
                    </div>
                </div><!-- // col-md-2 -->
                ...
                <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs hidden-sm">
					  <div class="dropdown">
                        <a data-toggle="dropdown" href="#" class="user-area">
                            <div class="thumb"><img src="{{asset('platformPublic/demo_img/user-1.png')}}" alt=""></div>
                            <h2>Rabie Elkheir</h2>
            ...
            <div class="row hidden-lg hidden-md" style="z-index: 3;">
                <div class="col-xs-1">
                  <button  class="w3-transparent" onclick="navshow('Demo0')"><i class="fa fa-closed-captioning"></i></button>  
                </div>
                <div class="col-xs-11">
