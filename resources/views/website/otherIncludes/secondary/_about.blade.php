<div class="about py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Welcome to
				<span class="font-weight-bold">Apagie/Musha</span>
			</h3>
			<div class="row pt-md-4">
				<div class="col-lg-6 about_right">
					<h3 class="text-capitalize text-right font-weight-light font-italic">interface friendly learning at
						<span class="font-weight-bold">Apagie</span>
					</h3>
					...
					<div class="about_left-list">
						<h6 class="mb-lg-3 mb-2 font-weight-bold text-dark">Why study at Apagie</h6>
						<ul class="list-unstyled">
							...
							<li class="mb-2">
								<a href="{{route('website.admissionSecondary')}}" class="w3-animate-fading"><img src="{{asset ('websitePublic/images/apply.png')}}" class="w3-animate-fading" height="100" width="230"></a>
						</ul>
					</div>
				</div>
				<div class="col-lg-6 left-img-agikes mt-lg-0 mt-sm-4 mt-3 text-right">
					<img src="{{asset('websitePublic/images/ab.jpg')}}" alt="" class="img-fluid" />

					<div class="about-bottom text-center p-sm-5 p-4 mt-3">
						<ul>
							<li>
								<h5>60+</h5>
