			...
			<div class="mis-stage">
				...
				<ol class="mis-slider">
					...
					<li class="mis-slide">
						...
						<a href="#" class="mis-container">
							...
							<figure>
								...
								<img src="{{asset ('publicUsers/images/t1.jpg')}}" alt=" " class="img-fluid" />
								<figcaption>Carl Lii
					...
					<li class="mis-slide">
						<a href="#" class="mis-container">
							<figure>
								<img src="{{asset ('publicUsers/images/t2.jpg')}}" alt=" " class="img-fluid" />
					...
					<li class="mis-slide">
						<a href="link" class="mis-container">
							<figure>
								<img src="{{asset ('publicUsers/images/t3.jpg')}}" alt=" " class="img-fluid" />
					...
					<li class="mis-slide">
						<a href="#" class="mis-container">
							<figure>
								<img src="{{asset ('publicUsers/images/t4.jpg')}}" alt=" " class="img-fluid" />
					...
					<li class="mis-slide">
						<a href="#" class="mis-container">
							<figure>
								<img src="{{asset ('publicUsers/images/t5.jpg')}}" alt=" " class="img-fluid" />
					...
					<li class="mis-slide">
						<a href="#" class="mis-container">
							<figure>
								<img src="{{asset ('publicUsers/images/t6.jpg')}}" alt=" " class="img-fluid" />
