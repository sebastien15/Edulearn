<header>
		<!-- top header -->
		<div class="top-head-w3ls py-2 bg-success">
			<div class="container">
				<div class="row">
					<h1 class="text-capitalize text-white col-5">
						<i class="fas fa-book text-dark bg-white p-2 rounded-circle mr-3"></i>welcome to @yield('title')</h1>
					<!-- social icons -->
